...
import { VoiceInterface } from '../../../components/session/voice-interface.jsx';
...
function installFunctionalRelayMocks(scenario) {
  ...
  window.WebSocket = function functionalWebSocket(url, protocols) {
    ...
    if (relayPaths.has(path)) {
      return new MockRelaySocket(resolved.toString());
    }
