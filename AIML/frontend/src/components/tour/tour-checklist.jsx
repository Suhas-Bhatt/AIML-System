...
import { useTourSafe } from './tour-provider.jsx';
import { TOUR_STEPS, TOUR_EDIT_URL_KEY } from './tour-steps.js';

function getStepNavUrl(step) {
...
export function TourChecklist({ open, onClose }) {
