import { CategoryCard } from '../../../components/docs/category-card.jsx';
import { DocsHeader } from '../../../components/docs/docs-header.jsx';
import { DocsSearch } from '../../../components/docs/docs-search.jsx';
import { categories, getCategoryArticles } from '../../../content/docs/index.js';
import Link from "next/link";

export const metadata = {
  title: "Docs | AIML System",
  description:
    "Learn how to use AIML System — guides for interview creators and interviewees.",
};
    ...
    <>
      ...
      <footer className="border-t border-mk-border/60 px-8 py-5">
        <div className="max-w-5xl mx-auto flex items-center justify-between text-xs text-mk-text-muted">
          <span>&copy; {new Date().getFullYear()} AIML System. All rights reserved.</span>
