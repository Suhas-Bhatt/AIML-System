...
export default function SettingsTab() {
  ...
  const [chatEnabled, setChatEnabled] = useState(interview.chatEnabled ?? true);
  const [voiceEnabled, setVoiceEnabled] = useState(interview.voiceEnabled ?? false);
  const [videoEnabled, setVideoEnabled] = useState(interview.videoEnabled ?? false);
  const [aiName, setAiName] = useState(interview.aiName);
  const [aiTone, setAiTone] = useState(interview.aiTone);
  const [followUpDepth, setFollowUpDepth] = useState(interview.followUpDepth);
  ...
  const [antiCheatingEnabled, setAntiCheatingEnabled] = useState(
    ...
    <div className="grid gap-6 md:grid-cols-2">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <Label>Maximum time limit (minutes)</Label>
            <Input
              type="number"
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={followUpDepth} onValueChange={setAiTone}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
