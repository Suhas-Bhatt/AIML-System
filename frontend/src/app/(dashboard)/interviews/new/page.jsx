...
import { AIGenerator } from '../../../../components/interview/ai-generator.jsx';
              ...
              <form onSubmit={handleManualCreate} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="duration">
                    {isZh ? "最长时限（分钟）" : "Maximum time limit (minutes)"}
                  </Label>
                  <Input
                    id="duration"
                    type="number"
                  ...
                  <p className="text-xs text-muted-foreground">
                    {isZh
                      ? "可选。面试的最长时限。"
                      : "Optional. Maximum time limit for the interview."}
                  </p>
                </div>
