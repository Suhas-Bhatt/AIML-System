...
export default function QuestionsPage() {
  ...
  const handleCopyToInterview = () => {
    ...
    createMutation.mutate({
      ...
      starterCode: copyDialog.starterCode ?? null,
    });
  };
  ...
  const processedQuestions = useMemo(() => {
    let result = (questions.data?.questions ?? []);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border">
        {projectLoading || (!!projectId && questions.isPending) ? (
          <div className="p-6">
          ...
          <div className="py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              {isFiltering
                ...
                : isZh
                  ? "创建面试后将显示题目。"
                  : "Questions will appear after creating an interview."}
            </p>
          </div>
        ) : (
          <>
        ...
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!copyTarget || createMutation.isPending}
            >
