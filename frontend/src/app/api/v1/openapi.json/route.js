...
const spec = {
  openapi: "3.1.0",
  info: {
    title: "AIML System Developer API",
    version: "1.0.0",
  ...
  components: {
    securitySchemes: {
      bearerAuth: {
        type: "http",
        scheme: "bearer",
        bearerFormat: "AIML System developer key",
        description:
    ...
    schemas: {
      ...
      Interview: {
        ...
        properties: {
          ...
          aiName: { type: "string", example: "AIML System" },
          aiTone: {
            type: "string",
      ...
      InterviewCreate: {
        ...
        properties: {
          ...
          aiName: { type: "string", default: "AIML System", example: "Alex" },
          aiTone: {
            type: "string",
            enum: ["CASUAL", "PROFESSIONAL", "FORMAL", "FRIENDLY"],
