...
import { useAntiCheating } from '../../hooks/use-anti-cheating.js';
import { useToast } from '../../hooks/use-toast.js';
import { trpc } from '../../lib/trpc/client.js';
import { AlertTriangle } from "lucide-react";
import { useCallback, useRef, useState } from "react";

export function AntiCheatingGuard({ enabled, sessionId }) {
    ...
    (violation) => {
      ...
      switch (violation.type) {
        ...
        case "paste": {
          ...
          toast({
            title: <span className="text-red-600 dark:text-red-400">External paste blocked</span>,
            description:
        ...
        case "multi_screen":
          toast({
            title: <span className="text-red-600 dark:text-red-400">Additional display detected</span>,
            description:
