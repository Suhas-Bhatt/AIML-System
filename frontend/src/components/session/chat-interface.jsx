...
export function ChatInterface({
  ...
  }, [currentQuestion, isCodingQuestion, isWhiteboardQuestion, drawings, activeDrawingIdx, codeSnippets, activeSnippetIdx, currentQ]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  const currentQuestionId = interview.questions[currentQuestion]?.id;
  const displayMessages = preview 
    ? previewMessages 
    : messages.filter(m => !m.questionId || m.questionId === currentQuestionId || m.role === "ASSISTANT");
