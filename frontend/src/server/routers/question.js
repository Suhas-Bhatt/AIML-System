...
import { getOrgMembership, assertMinRole, hasProjectAccess, filterAccessibleProjectIds, getEffectiveProjectRole } from '../trpc.js';
  ...
  listAll: protectedProcedure
    ...
    .query(async ({ ctx, input }) => {
      ...
      let query = ctx.supabase
        .from("questions")
        .select("id, text, description, type, createdAt, interview:interviews!inner(id, title)")
