import { DocCallout } from '../../components/docs/doc-callout.jsx';
import { DocImage } from '../../components/docs/doc-image.jsx';

export const resultsAnalyticsArticles = [
  {
    ...
    content: () => (
      <>
        ...
        <h2>AI Analysis</h2>
        <p>
          After a candidate completes a session, AIML System automatically produces:
        </p>
        <ul>
        ...
        <p>
          For interviews with research-type questions, AIML System also extracts structured findings: <strong>topics</strong> (themes, pain points, preferences) and <strong>data points</strong> (specific facts, numbers, or statements). Topics help you spot patterns across sessions; data points give you quotable evidence for reports.
        </p>
        ...
        <p>
          AIML System analyzes the candidate&apos;s communication style across every response — detecting confidence level, tone consistency, and clarity. Each question is rated for tone (e.g., Confident, Neutral) and impact (High, Low), giving you a quick read on how the candidate communicates under interview conditions.
        </p>
