...
export const teamsOrganizationsArticles = [
  {
    ...
    content: () => (
      <>
        <h2>Organizations</h2>
        <p>
          An organization is the top-level account that owns all interviews, questions, and sessions. When you sign up, AIML System creates a <strong>Personal</strong> organization for you automatically.
        </p>
        <p>
        ...
        <p>
          Click <strong>+ Add member</strong>, enter the person&apos;s email address, and choose a role. If they don&apos;t have an AIML System account yet, they&apos;ll receive an invitation.
        </p>
