...
export const troubleshootingArticles = [
  {
    ...
    content: () => (
      <>
        ...
        <p>
          AIML System saves your progress automatically. Return to the same interview link to resume where you left off. If a reconnect button appears, click it. Otherwise, refresh the page.
        </p>
        <ul>
    ...
    content: () => (
      <>
        ...
        <ul>
          ...
          <li><strong>Mobile browsers</strong> — AIML System can run on mobile, but screen size and background tab behavior may affect the experience. Use desktop for important interviews.</li>
        </ul>

        <DocCallout variant="info">
          Keep your browser up to date. Older versions may lack WebRTC and audio API fixes that AIML System depends on.
        </DocCallout>
