export const faqArticles = [
  {
    ...
    categorySlug: "faq",
    title: "General FAQ",
    description: "Common questions about AIML System",
    audience: "both",
    order: 1,
    content: () => (
      <>
        ...
        <h3>Can I use AIML System for free?</h3>
        <p>
          Yes. AIML System is open-source and all features are available without any usage limits. You only need to provide your own AI provider API keys (e.g. OpenAI, Kimi, MiniMax).
        </p>
        ...
        <p>
          Chrome on desktop is recommended for full voice, video, and interactive tool support. Safari and Firefox generally work but may have limitations. Mobile browsers can run AIML System, though a desktop is recommended for critical interviews.
        </p>
        ...
        <p>
          AIML System saves your progress automatically. Return to the same interview link to resume where you left off. The interviewer can also view any data captured before the disconnection.
        </p>
