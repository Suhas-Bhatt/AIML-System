...
import { DocLink } from '../../components/docs/doc-link.jsx';
...
export const gettingStartedArticles = [
  {
    ...
    content: () => (
      <>
        ...
        <p>
          AIML System is an AI-powered interview platform that conducts structured interviews autonomously. You design an interview, share a link, and AIML System&apos;s AI handles the conversation — asking questions, probing with follow-ups, and generating detailed analysis when the session is complete.
        </p>
