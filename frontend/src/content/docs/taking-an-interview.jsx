...
import { DocFeature, DocFeatureGrid } from '../../components/docs/doc-feature-grid.jsx';
import { DocImage } from '../../components/docs/doc-image.jsx';
import { DocStep, DocSteps } from '../../components/docs/doc-steps.jsx';

export const takingAnInterviewArticles = [
  {
      ...
      <>
        ...
        <DocSteps>
          <DocStep step={1} title="Open the Link and Enter Your Details">
            <p>Click the interview link to open the AIML System interview page. On the welcome screen, enter your full name and email address, then click <strong>Begin Interview</strong>.</p>
  ...
  },
  {
    ...
    content: () => (
      <>
        ...
        <p>
          AIML System saves your progress automatically. Return to the same interview link, verify your identity if prompted, and continue where you left off — previous answers are preserved.
        </p>
